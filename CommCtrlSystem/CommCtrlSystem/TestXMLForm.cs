    ...
    public partial class TestXMLForm : Form
    {
        ...
        private void createExcelFile(string FileName, int room)
        {
            ...
            try
            {
                ...
                row1.CreateCell(i++).SetCellValue(textBox9.Text);
                row1.CreateCell(i++).SetCellValue(textBox10.Text);
                row1.CreateCell(i++).SetCellValue(textBox11.Text);
                row1.CreateCell(i++).SetCellValue(textBox12.Text);
                row1.CreateCell(i++).SetCellValue(textBox13.Text);
                row1.CreateCell(i++).SetCellValue(textBox14.Text);
